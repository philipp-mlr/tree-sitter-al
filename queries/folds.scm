...
(table_declaration body: (_) @fold)
(tableextension_declaration body: (_) @fold)
(page_declaration body: (_) @fold)
(pageextension_declaration body: (_) @fold)
(pagecustomization_declaration body: (_) @fold)
(codeunit_declaration body: (_) @fold)
(report_declaration body: (_) @fold)
(reportextension_declaration body: (_) @fold)
(query_declaration body: (_) @fold)
(xmlport_declaration body: (_) @fold)
(enum_declaration body: (_) @fold)
(enumextension_declaration body: (_) @fold)
(interface_declaration body: (_) @fold)
(profile_declaration body: (_) @fold)
(profileextension_declaration body: (_) @fold)
(controladdin_declaration body: (_) @fold)
(permissionset_declaration body: (_) @fold)
(permissionsetextension_declaration body: (_) @fold)
(entitlement_declaration body: (_) @fold)
(dotnet_declaration body: (_) @fold)
